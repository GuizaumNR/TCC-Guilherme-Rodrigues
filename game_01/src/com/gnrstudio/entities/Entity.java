...
public class Entity {
	...
	public static BufferedImage WEAPON_EN = Game.spritesheet.getSprite(112, 0, 9, 4);
	...
	public static boolean isColidding(Entity e1, Entity e2) {
		Rectangle e1Mask = new Rectangle(e1.getX() + e1.maskx, e1.getY() + e1.masky, e1.getHeight() + e1.mheight, e1.getWidth() + e1.mwidth);
		Rectangle e2Mask = new Rectangle(e2.getX() + e2.maskx, e2.getY() + e2.masky, e2.getHeight() + e2.mheight, e2.getWidth() + e2.mwidth);
